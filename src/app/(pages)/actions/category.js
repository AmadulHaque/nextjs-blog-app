...
export async function CategorShow(id) {
  try {
    ...
    return { success: true, message: 'Category show successfully', data: resData.data };
  } catch (error) {
    return { success: false, errors: { global: 'An error occurred during categories fetch' } };
  }
}
...
export async function CreateCategory(formData) {
  ...
  try {
    ...
    console.log(error);
    return { success: false, errors: { global: 'An error occurred during category' } }
  }
}
...
export async function CategorDelete(id) {
  try {
    ...
    return { success: false, errors: { global: 'An error occurred during categories deleted' } };
  }
}
