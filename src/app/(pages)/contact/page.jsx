    ...
    <>
      <div className="bg-gray-50 py-6">
        <div className="xl:container mx-auto px-3 sm:px-4 xl:px-2">
          <div className="flex flex-row flex-wrap"> {/* Left */} <div className="flex-shrink max-w-full w-full lg:w-2/3  overflow-hidden">
              <div className="w-full py-3">
                <h2 className="text-gray-800 text-3xl font-bold">
                  <span className="inline-block h-5 border-l-3 border-red-600 mr-2" />{" "} Contact Us
                </h2>
              </div>
                    ...
                    <form className="flex flex-wrap flex-row -mx-4">
                      ...
                      <div className="flex-shrink max-w-full px-4 w-full mb-6">
                        <label className="flex items-center">
                          <input type="checkbox" name="checked-demo" defaultValue={1} className="form-checkbox h-5 w-5 text-blue-500 dark:bg-gray-700 border border-gray-100 dark:border-gray-700 focus:outline-none" required="" />
                          <span className="text-gray-700 ml-4"> I agree to the Terms of Use </span>
                        </label>
                      </div>
                      <div className="flex-shrink max-w-full px-4 w-full">
                        <button className="flex items-center py-3 px-5 leading-5 text-gray-100 bg-black hover:text-white hover:bg-gray-900 hover:ring-0 focus:outline-none focus:ring-0" type="submit"> Send messages </button>
                      </div>
                    </form>
                  </div>
                </div>
